...
namespace ZDWindowsFormsTest
{
	...
	public partial class Form1 : Form
    {
        ...
        public ZDRootNodeGraph nodeGraph = new ZDRootNodeGraph();
        public ZDRootNodeGraph nodeGraph2;
        public Form1 form1;
        ...
        public string NetworkIPAddress= "127.0.0.1";
        public int NetworkPort=6666;
        public Form1()
        {
            InitializeComponent();
        ...
        private void ConnectButton_Click(object sender, EventArgs e)
        {
            ...
            if (nodeGraph.NetworkState != ZDNodeGraphNetworkState.Connected)
            {
              ...
              //  FormConnect fconnect = new FormConnect( nodeGraph,  NetworkIPAddress,  NetworkPort);
             //   fconnect.ShowDialog(this);
               nodeGraph.NetworkIPAddress = NetworkIPAddress;
                nodeGraph.NetworkPort = NetworkPort;
                 nodeGraph.Connect();
               // timer1.Start();
               // nodeGraph.RequestDisconnectPins();
            }
            else
            {
		...
		private void timer1_Tick(object sender, EventArgs e)
		{
			...
			if (nodeGraph.NetworkState == ZDNodeGraphNetworkState.Connected)
			{
                ...
                foreach (var node in nodeGraph.Nodes)
				{
					...
					{
                        // if(node.DependencyObjectType.Name.Equals("ZDNode")&& node.DependencyObjectType.Name.Substring(0,4).Equals("ZDA_"))
...
//endregion        #region ListBox2拖拽   
        ...
        private void InBroadcast(object sender, EventArgs e)
        {
        ...
        private void InEdit_Click(object sender, EventArgs e)
        {
        ...
        private void CloseDrama_Click(object sender, EventArgs e)
        {
            ...
            AnimatePreviewList.Items.Clear();
            PropertiseAddList.Items.Clear();
            StatusLight.BackgroundImage = ZDWindowsFormsTest.Properties.Resources.redlight;
            // nodeGraph.NetworkState = 0;

            // nodeGraph.Dispatcher.Thread.DisableComObjectEagerCleanup();
            //timer1.Stop();
          /*  nodeGraph.DoNetworkUpdate = false;
            nodeGraph.NetworkState = 0;
            ZDNodeEventConnection s=new ZDNodeEventConnection();
            nodeGraph.RequestDisconnectEvents(s);*/
            // nodeGraph.Disconnect();

        }

        private void ConCfirmBtn_Click(object sender, EventArgs e)
        {
